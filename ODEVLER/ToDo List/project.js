...
// const filterTodos = (e) => {
//  if(Array.from(todo_container.children)
//     .filter((todo) => todo.firstChild.textContent.includes(e))){
//       console.log(true)
//     }
//     // .forEach((todo) => todo.classList.add("filtered"));

//   // const todos = JSON.parse(localStorage.getItem("todos"));
//   // console.log(todo_container.children);
//   // for (i = 0; i < todos.length; i++) {
//   //   if(!todos[i].text.toLowerCase().includes(e)){
...
const addHTML = (todo) => {
  ...
  todoCb.classList.add("todo_cb", "checkmark");
